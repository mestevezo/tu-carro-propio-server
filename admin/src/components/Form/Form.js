    ...
    <Paper className={classes.paper}>
      ...
      >
        <Typography variant="h6">
          {currentId ? `Editing "${post.title}"` : "Creating a Car Entry"}
        </Typography>
        ...
        <TextField
          ...
          value={postData.year}
          onChange={(e) =>
            setPostData({ ...postData, year: parseInt(e.target.value) })
          }
        />
        ...
        <TextField
          ...
          value={postData.km}
          onChange={(e) =>
            setPostData({ ...postData, km: parseInt(e.target.value) })
          }
        />
        ...
        <TextField
          ...
          onChange={(e) =>
            setPostData({ ...postData, power: parseInt(e.target.value) })
          }
        />
        ...
        <TextField
          ...
          onChange={(e) =>
            setPostData({ ...postData, fuelCapacity: parseInt(e.target.value) })
          }
        />
        ...
        <FormControl fullWidth>
          ...
          <Select
            ...
            label="Trasmision"
            onChange={(e) =>
              setPostData({ ...postData, transmission: e.target.value })
            }
          >
        ...
        <FormControlLabel
          control={
            <Switch
              ...
              onChange={(e) =>
                setPostData({ ...postData, armor: e.target.checked })
              }
            />
          }
          label="Blindaje"
        ...
        <FormControlLabel
          control={
            <Switch
              ...
              onChange={(e) =>
                setPostData({ ...postData, t4x4: e.target.checked })
              }
            />
          }
          label="4x4"
        ...
        <TextField
          ...
          onChange={(e) =>
            setPostData({ ...postData, addInfo: e.target.value })
          }
        />
        ...
        <div className={classes.fileInput}>
          <FileBase
            ...
            multiple={true}
            onDone={(e) =>
              setPostData({ ...postData, othersImg: getImages(e, "name") })
            }
          />
        </div>
